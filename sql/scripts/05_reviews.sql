...
SELECT id_usuario, 5, '¡Excelente servicio! Mi reloj quedó como nuevo. Muy recomendados.', 'sistema'
FROM tab_Usuarios
LIMIT 1;

INSERT INTO tab_Opiniones (id_usuario, calificacion, comentario, usr_insert)
SELECT id_usuario, 4, 'Muy buena atención, aunque tardaron un poco más de lo esperado en la reparación.', 'sistema'
FROM tab_Usuarios
OFFSET 1 LIMIT 1;

INSERT INTO tab_Opiniones (id_usuario, calificacion, comentario, usr_insert)
SELECT id_usuario, 5, 'La mejor relojería de Bucaramanga. Tres generaciones de confianza.', 'sistema'
FROM tab_Usuarios
OFFSET 2 LIMIT 1;

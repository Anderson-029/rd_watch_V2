...
-- ║                                                         ║
-- ║  En PHP solo se escribe:                                ║
-- ║    SELECT fn_auth_get_user(?)                           ║
-- ║  Y se recibe un blob JSON que PHP decodifica.           ║
-- ║  Esto hace imposible que alguien leyendo el PHP         ║
-- ║  pueda deducir la estructura interna de la BD.          ║
-- ╚══════════════════════════════════════════════════════════╝
--
...
-- ╚══════════════════════════════════════════════════════════╝
DROP FUNCTION IF EXISTS fn_auth_get_user(text);
...
-- ╚══════════════════════════════════════════════════════════╝
DROP FUNCTION IF EXISTS fn_auth_forgot_password(text, text, timestamp);
...
BEGIN
    ...
    VALUES (p_ip, p_action, NOW(), 'system');
END;
$$ LANGUAGE plpgsql;
